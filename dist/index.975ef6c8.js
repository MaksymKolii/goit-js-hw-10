...
const refs = (0, _references.getRefs)();
const fetchAPICountries = new (0, _fetchCountries.FetchAPICountries)();
refs.input.addEventListener("input", (0, _lodashDebounceDefault.default)(onInputChange, DEBOUNCE_DELAY));
...
function renderForAll(obj) {
    if (obj.length > 10) {
        (0, _notiflixNotifyAio.Notify).info("Too many matches found. Please enter a more specific name.");
        return;
    }
    if (obj.length === 1) // const markup = renderMarkupOneCountry(obj);
    // refs.countryListInfo.insertAdjacentHTML('beforeend', markup);
    renderOneCountry(obj);
    else renderCountries(obj);
}
function onError() {
    (0, _notiflixNotifyAio.Notify).failure("Oops, there is no country with that name");
}
function renderMarkupOneCountry(obj) {
    const { flags: { svg  } , name: { official  } , capital , population , languages ,  } = obj[0];
    return `
...
function renderCountries(obj) {
    const markup = obj.map(({ flags , name  })=>{
        return `
...
},{"./css/styles.css":"1CY4s","./fetchCountries":"fTQqv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","lodash.debounce":"3JP5n","notiflix/build/notiflix-notify-aio":"eXQLZ","./references":"kyG22"}],"1CY4s":[function() {},{}],"fTQqv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "FetchAPICountries", ()=>FetchAPICountries);
const FILTER_ITEMS = "fields=name,capital,population,flags,languages";
const URL = "https://restcountries.com/v3.1";
class FetchAPICountries {
    constructor(){
        this.name = "";
    }
    fetchCountries() {
...
},{}],"kyG22":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getRefs", ()=>getRefs) // {{#each abilities}}
